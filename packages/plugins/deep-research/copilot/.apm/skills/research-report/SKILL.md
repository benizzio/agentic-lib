---
# Generated from source/skills/research-report/SKILL.md; do not edit.
name: research-report
description: Summarize deep research results into a Markdown report that covers all fields and skips uncertain values. Use after deep research results have been generated.
license: MIT
---
...
## Trigger
Use this workflow when the user asks to generate a report from deep research results.
...
Ask the user and wait for a response:
- Which fields should be displayed in the TOC besides item name?
